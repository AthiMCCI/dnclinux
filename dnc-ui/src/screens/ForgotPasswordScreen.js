/*###############################################################################
// Module: ForgotPasswordScreen.js
// 
// Function:
//      Function to Forgot password screen
// 
// Version:
//    V1.02  Tue Dec 01 2021 10:30:00  AthiSankar   Edit level 3
// 
//  Copyright notice:
...
const ForgotPasswordScreen = ({ navigation }) => {
  ...
  return (
    <Background>
      ...
      />)}
      <Button mode="contained" color ="#53A0FE" onPress={sendPressed} style={{ marginTop: 16, }} > Submit </Button>
      ...
      <View style={{position: 'absolute', bottom: 10, marginHorizontal: 'auto'}}>
        <Text style={{ color: 'Black', fontSize: 11, fontWeight: 'bold' }}>DNC |{uiversion}| Server {version}</Text>
      </View>
