...
import {LoginScreen,AdminSignup,ForgotPasswordScreen,Dashboard,UserSignup,UserScreen,ClientScreen,
  RegisterDevice,Configuredevice,DataDownload
} from './src/screens' 
...
const DataDownloadstack = createStackNavigator()
...
const Homestackscreen=({navigation}) =>(
  <Homestack.Navigator initialRouteName="LoginScreen" screenOptions={{headerShown: false}}>
    ...
    <Homestack.Screen name="DataDownload" component={DataDownload} /> 
...
//Stack navigation for DataDownload screen
const DataDownloadstackScreen=({navigation}) =>(
  <DataDownloadstack.Navigator screenOptions={{headerShown: false}}>
      <DataDownloadstack.Screen name="DataDownload" component={DataDownload} />  
  </DataDownloadstack.Navigator>
